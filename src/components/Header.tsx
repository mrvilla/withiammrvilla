        ...
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <button
              ...
              className="bg-[#a47764] hover:bg-[#8d6854] text-white px-6 py-2 rounded-lg transition-colors font-medium"
            >
              Book Now
            </button>
          </nav>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-gray-900 border-t border-gray-800">
            <div className="px-2 pt-2 pb-3 space-y-1">
              <button
                onClick={() => scrollToSection('home')}
                className="block px-3 py-2 text-gray-300 hover:text-[#a47764] transition-colors w-full text-left"
              >
                Home
              </button>
              <button
              ...
              <button
                onClick={() => scrollToSection('contact')}
                className="block px-3 py-2 bg-[#a47764] hover:bg-[#8d6854] text-white rounded-lg transition-colors w-full text-left mt-2"
              >
                Book Now
              </button>
            </div>
